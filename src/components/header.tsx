    ...
    <div className={block}>
      ...
      >
        ...
        <div className={`${block}__cart-drawer-container`}>
          <div className={`${block}__cart-drawer-container-inner container`}>
            {cartContext.items.length === 0 ? (
              ...
              <div className={`${block}__cart-drawer-items`}>
                ...
                <div className={`${block}__cart-drawer-actions`}>
                  <button
                    className={`${block}__cart-drawer-checkout-button button`}
                  ...
                  <button
                    className={`${block}__cart-drawer-clear-button button`}
